...
class SimulatedData:
    def __init__(self, hr_ratio,
        ...
        Parameters:
            ...
            censor_mode: the method to calculate whether a patient is censored.
                ...
                'observed_p': requires the parameter observed_p, which is the percentage of patients with observed death times
    ...
    def generate_data(self, N,
        ...
        # If Censor_mode is 'observed_p': then find the end time in which observed_p percent of patients have an
        # observed death
